...
/**
 * Test case for class Tx_Sharepoint_connector_Controller_SharepointListController.
 *
 * @version $Id$
 ...
 */
class SharepointListControllerTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	/**
	 * @var 
	 */
	protected $fixture;
